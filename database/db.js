...
const Connection = async (username, password) => {
   ...
   const URL=`mongodb+srv://${username}:${password}@cluster0.ni4eq.mongodb.net/ecommerce?retryWrites=true&w=majority`;
    try {
        await mongoose.connect(URL, { useUnifiedTopology: true, useNewUrlParser: true, useFindAndModify: true,useCreateIndex: true  });
